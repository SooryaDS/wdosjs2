...
const numlocalAdultTickets = parseInt(document.getElementById('sladult').value);
const numlocalChildTickets = parseInt(document.getElementById('slchild').value);
const numfAdultTickets = parseInt(document.getElementById('fadult').value);
const numfChildTickets = parseInt(document.getElementById('fchild').value);
...
if(numlocalAdultTickets > 0) {
    document.getElementById('slAdultsss').style.display = 'table-row';
    ...
    document.getElementById('slAdultsss').style.display = 'none';
...
if(numlocalChildTickets > 0) {
  document.getElementById('slChilddd').style.display = 'table-row';
  ...
  document.getElementById('slChilddd').style.display = 'none';
...
if(numfAdultTickets > 0) {
  document.getElementById('fAdultsss').style.display = 'table-row';
...
if(numinfantTickets > 0) {
  ...
  document.getElementById('infantsssRow').style.display = 'none';
...
document.getElementById("totPaysummary").textContent = "$"+totalAmountPayable ;
// Store 'totPaysummary'
localStorage.setItem('totPaysummary', document.getElementById('totPaysummary').textContent);

//local data storage :)
const summaryTable = {
  selectedDate: chosenDate,
  selectedTimeSlot: selectedTimeSlots.join(", "),
  timehrs: totalHrs + " hour/s",
  durationnn: normalCount + " normal hour/s, " + peakCount + " peak hour/s",
  ...
  totPaysummary: "$" + totalAmountPayable
};
...
document.getElementById('durationnn').innerHTML = totalHrs+" hour/s("+normalCount + " normal hour/s, " + peakCount + " peak hour/s)";
...
["timeSlots", "sladult", "slchild", "fadult", "fchild", "infant"].forEach(function(id) {
...
//3 Store 'timehrs'
localStorage.setItem('timehrs', document.getElementById('timehrs').innerHTML);
//4 Store 'durationnn'
localStorage.setItem('durationnn', document.getElementById('durationnn').innerHTML);
...
window.onload = function() {
  ...
  document.getElementById('timehrs').innerHTML="7 to 8";
  document.getElementById('durationnn').innerHTML=" 1 hour/s(1 normal hour/s, 0 peak hour/s)";
  document.getElementById('slAdultsss').style.display = 'none';
  document.getElementById('slChilddd').style.display = 'none';
